...
Scenario Outline: TC01_validation of booking with invalid details
  ...
  When user enter "<firstname>" and "<lastname>" and "<billingaddress>" and "<creditcardnumber>" and "<cvvnumber>"
  When user select book now button
  Then user should get order number
   Examples:
   | firstname | lastname | billingaddress | creditcardnumber | cvvnumber  |
