...
public class StepDefinitions 
{
	...
	{
		driver.findElement(By.id("first_name")).sendKeys("Logan");
		driver.findElement(By.id("last_name")).sendKeys("kumar");
	}

	@When("user enters valid Booking address")
	public void user_enters_valid_Booking_address() 
	{
	  driver.findElement(By.xpath("//textarea[@rows='4']")).sendKeys("coimbatore location");
	}
	@When("user enters valid credit card details")
	public void user_enters_valid_credit_card_details()
	{
	   driver.findElement(By.xpath("(//input[@type='text'])[13]")).sendKeys("1234567891012141");   
	}
