...
public class CoglesStepDef extends LibGlobal
{

	@When("User accept cookies")
	public void user_accept_cookies() throws AWTException 
	{
	      WebElement cooki = driver.findElement(By.id("onetrust-accept-btn-handler"));
	      cooki.click();
	      Robot r = new Robot();
...
public void user_enters_valid_keyword_for_checkout() {
	HomePage hp = new HomePage();
	LibGlobal.sendValue(hp.getSearchbox(),"tshirt");
	LibGlobal.click(hp.getSearchbtn());
}
